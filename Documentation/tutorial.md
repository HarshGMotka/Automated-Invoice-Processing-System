...
Existing templates can be found in the [templates folder](https://github.com/HarshGMotka/Automated-Invoice-Processing-System/blob/master/Documentation/src/invoice2data/extract/templates) of the installed
